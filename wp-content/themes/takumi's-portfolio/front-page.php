<?php
/**
 * フロントページテンプレート — スクロールで富士山を登る登山モード
 */
get_header();
...
<main class="climb">
	<!-- 実写の富士山 → 3Dへのクロスフェード導入 -->
	<div class="hero__photo hero__photo--fixed">
		<img src="<?php echo esc_url( $uri ); ?>/assets/img/富士山_text.png" alt="Building the future, one line at a time. 富士山">
	</div>
